...
const Contactus = () => {
    const handelSubmit = (e) => {
        e.preventDefault()
        emailjs.sendForm('service_uchyy8e', 'template_a8h96cg', e.target, 'B3FiuvQc4AkxpalNW')
            .then((result) => {
                console.log(result.text);
                toast.success('Mail send Sucessfully! We will reach out shortly', {
                    position: "top-center",
                    autoClose: 3000,
            ...
            <section className="text-gray-600 body-font relative min-h-screen mt-8 md:mt-0">
                <div className="container px-5 -py-4 md:py-12 mx-auto">
                    <div className="flex flex-col text-center w-full mb-12">
                        ...
                        <p className="lg:w-2/3 mx-auto leading-relaxed text-base">For any query please feel free to contact us.</p>
                    </div>
                        ...
                        <form onSubmit={handelSubmit} method="post">
                            <div className="flex flex-wrap -m-2">
                                ...
                                <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                                    <Link href="mailto:kapilmundada21@gmail.com"><a className="text-indigo-500">kapilmundada21@gmail.com</a></Link>
                                    <p className="leading-normal my-5">Nashik Maharashtra</p>
